...
const ServicePreviewCard = ({ service }: Props) => {
  ...
  return (
    <li
      key={service.title}
      className="p-7.5 lg:p-10 2xl:p-12.5 flex flex-col gap-6 h-full border-b last:border-b-0 lg:border-b-0 lg:border-r lg:last:border-r-0  hover:-translate-y-1 transition-transform duration-300 group"
    >
      {/* Header */}
