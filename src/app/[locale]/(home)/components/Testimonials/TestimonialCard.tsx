...
const TestimonialCard = ({ testimonial }: Props) => {
  ...
  return (
    <li className="py-10 lg:py-20 2xl:py-25 px-6 lg:px-15 2xl:px-20 flex flex-col gap-y-6 lg:gap-y-7.5 h-full border-x border-b lg:odd:border-r-0 hover:border-b-app-primary transition-colors duration-300 group">
      {/* Header */}
